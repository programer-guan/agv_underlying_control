...
void EXTIX_Init(void)
{
   ...
   //GPIOE.3	  中断线以及中断初始化配置 下降沿触发 //KEY2
...
{
//u8 forward[] = "i r8 0x8000\r\n"; 
	delay_ms(10);//消抖
	if(WK_UP==1)	 	 //WK_UP按键
	{
//	USART_Send_Data(USART3, forward, 13);
	}
...
{
//u8 pause[] = "i r8 0x8004\r\n";
	delay_ms(10);//消抖
	if(KEY1==0)	  //按键KEY2
	{
//	USART_Send_Data(USART3, pause, 13);
	}		 
...
//u8 backward[] = "i r8 0x8001\r\n";
	...
	if(KEY0==0)	 //按键KEY0
	{
//	USART_Send_Data(USART3, backward, 13);
	}		
