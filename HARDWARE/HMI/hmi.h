...
#define HMI_KEY_BACK  1
#define HMI_KEY_OK    2
#define HMI_KEY_UP	  3
#define HMI_KEY_DOWN  4
#define HMI_KEY_LEFT  5
#define HMI_KEY_RIGHT 6
...
typedef struct HMI_Main{
	...
	void (*CLRAR)( );					//清除显示内容
	void (*PUTC)(unsigned char,unsigned char,unsigned char);	//打印字符函数指针:行 列 字符
